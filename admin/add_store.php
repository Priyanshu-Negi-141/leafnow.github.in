...
if(isset($_POST['submit']))           //if upload btn is pressed
{
	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
								...
								$store = "plants_img/".basename($fnew);                      // the path to store the upload image
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO store(c_id,title,email,phone,o_hr,c_hr,o_days,address,image) VALUE('".$_POST['c_name']."','".$res_name."','".$_POST['email']."','".$_POST['phone']."','".$_POST['o_hr']."','".$_POST['c_hr']."','".$_POST['o_days']."','".$_POST['address']."','".$fnew."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql); 
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><img src="https://img.icons8.com/ios/24/000000/maple-leaf.png"/><span class="hide-menu">Plants</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_plant.php">All Plants</a></li>
								<li><a href="add_plant.php">Add Plant</a></li>
                                            ...
                                            <!--/span-->
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                 ...
                                                 <?php $ssql ="select * from plant_category";
