...
?>									
                                        ...
                                        <div class="title-row">
										<?php echo $item["title"]; ?><a href="plants.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>" >
...
?>								  
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
						...
						<?php  // display values and item of Plant/plants
									$stmt = $db->prepare("select * from plants where rs_id='$_GET[res_id]'");
									$stmt->execute();
                                ...
                                <div class="Plant-item">
                                    <div class="row">
										...
										<form method="post" action='plants.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="store-logo pull-left" href="#"><?php echo '<img src="admin/_img/plants/'.$product['img'].'" alt="Plant logo">'; ?></a>
                                            </div>
                                            <!-- end:Logo -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body cart-addon">
                    <div class="Plant-item white">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                <div class="item-img pull-left">
                                    <a class="store-logo pull-left" href="#"><img src="http://placehold.it/70x70" alt="Plant logo"></a>
                                </div>
                                <!-- end:Logo -->
                                <div class="rest-descr">
