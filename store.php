...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="inner-page-hero bg-image" data-image-src="images/img/wall1.jpg">
									      ...
									      while($rows=mysqli_fetch_array($ress))
										  {
													 ...
													 echo' <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
															<div class="entry-logo">
																<a class="img-fluid" href="dishes.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Plant logo"></a>
															</div>
															<!-- end:Logo -->
														 ...
														 <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
																<div class="right-content bg-white">
																	<div class="right-review">
																		...
																		<p> 245 Reviews</p> <a href="plants.php?res_id='.$rows['rs_id'].'" class="btn theme-btn-dash">View Plant</a> </div>
																</div>
																<!-- end:right info -->
															</div>';
										  }
